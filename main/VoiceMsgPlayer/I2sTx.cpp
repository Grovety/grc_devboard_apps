...
#define I2S_BLK_PIN      GPIO_NUM_34
#define I2S_WS_PIN       GPIO_NUM_35
#define I2S_DATA_OUT_PIN GPIO_NUM_33

#define GAIN_PIN   GPIO_NUM_NC
#define SDMODE_PIN GPIO_NUM_NC
#else
...
void i2s_init(void) {
  ...
  chan_cfg.dma_frame_num = I2S_TX_SAMPLE_LEN;
...
void i2s_play_wav(const void *data, size_t bytes) {
  ...
  ESP_LOGV(TAG, "wrote bytes=%u/%u", wrote_bytes, bytes);
}
